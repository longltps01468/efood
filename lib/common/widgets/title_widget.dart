  ...
  Widget build(BuildContext context) {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(title!, style: rubikBold.copyWith(color: themeProvider.darkTheme ? Theme.of(context).colorScheme.onSecondary : ColorResources.homePageSectionTitleColor)),
      ]),
      ...
      if(onTap != null && !isShowTrailingIcon) InkWell(
        ...
        child: Padding(
          ...
          child: Text(
            ...
            style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: themeProvider.darkTheme ? Theme.of(context).colorScheme.onSecondary : ColorResources.homePageSectionTitleColor),
          ),
        ),
      ),
    ]);
