...
class SplashRepo {
  ...
  Future<ApiResponseModel> getDeliveryInfo(int branchId) async {
    try {
      final response = await dioClient!.get("${AppConstants.baseUrl}${AppConstants.getDeliveryInfo}?branch_id=$branchId");
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
