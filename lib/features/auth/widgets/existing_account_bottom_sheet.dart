      ...
      Padding(
        ...
        child: RichText(
          ...
          text: TextSpan(children:[
            ...
            TextSpan(
              text: ' ${widget.userInfoModel.email} ',
                ...
                if(authProvider.isPhoneNumberVerificationButtonLoading){
                  ...
                  authProvider.existingAccountCheck(
                    ...
                    if(responseModel != null && responseModel.isSuccess && responseModel.message == 'token') {
                      ...
                      RouterHelper.getOtpRegistrationScreen(tempToken!, widget.userInfoModel.email!, userName: "${widget.userInfoModel.fName} ${widget.userInfoModel.lName}");
                    }
