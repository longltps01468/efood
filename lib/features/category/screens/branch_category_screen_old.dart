...
class QProductList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CategoryProvider>(
      builder: (context, categoryProvider, _) {
        return categoryProvider.categoryProductModel == null ? const Center(child: CircularProgressIndicator()) : (categoryProvider.categoryProductModel?.products?.isNotEmpty ?? false) ?  GridView.builder(
